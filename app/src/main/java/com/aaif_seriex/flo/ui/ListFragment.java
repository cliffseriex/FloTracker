 ...
 */
public class ListFragment extends AppCompatActivity implements AdapterView.OnItemClickListener {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Iterator<PeriodicalDatabase.DayEntry> dayIterator = dbMain.dayEntries.iterator();
        int pos = 0;
        PeriodicalDatabase.DayEntry dayPrevious = null;
        PeriodicalDatabase.DayEntry day = null;
        ...
        /*SupportActivity actionBar = getSupportActionBar();
    ...
    public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
        ...
        if (dbMain != null && position >= 0
            ...
            PeriodicalDatabase.DayEntry selectedEntry = dbMain.dayEntries.get(position);
