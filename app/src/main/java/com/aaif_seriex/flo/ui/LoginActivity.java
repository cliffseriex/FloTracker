...
import com.aaif_seriex.flo.data.SharedPreferenceHelper;
import com.aaif_seriex.flo.data.StaticConfig;
import com.aaif_seriex.flo.model.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( user!= null){
            Intent i = new Intent(this, MainActivityApp.class);
            startActivity(i);
        } if(isFirstTime){
    ...
    public void clickRegisterLayout(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options =
                    ActivityOptions.makeSceneTransitionAnimation(this, btn_register, btn_register.getTransitionName());
    ...
    public void clickLogin(View view) {
       /* Intent intent = new Intent(getApplicationContext(),MainActivityApp.class);
        ...
        if (validate(username, password)) {
            Intent ii = new Intent(this,MainActivityApp.class);
            startActivity(ii);
