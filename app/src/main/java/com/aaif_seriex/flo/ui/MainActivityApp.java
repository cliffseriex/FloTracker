...
import com.aaif_seriex.flo.data.PeriodicalDatabase.*;
import com.aaif_seriex.flo.util.PreferenceActivity;
import com.aaif_seriex.flo.util.PreferenceUtils;
import com.aaif_seriex.flo.ui.CalendarCell.*;
import com.aaif_seriex.flo.util.PreferenceActivity.*;
...
public class MainActivityApp extends AppCompatActivity
    ...
    private void community() {
        ...
        Intent i = new Intent(this,Community.class);
        startActivity(i);
    ...
    private void showCalendar() {
        Intent i = new Intent(this, boardingSetUp.class);
        startActivity(i);
    }
