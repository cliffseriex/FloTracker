...
import com.aaif_seriex.flo.util.GregorianCalendarExt;
import com.aaif_seriex.flo.util.PreferenceUtils;
...
class PeriodicalDatabase {
    ...
    public static class DayEntry {
        ...
        public final static int PERIOD_START = 1;
        public final static int PERIOD_CONFIRMED = 2;
        public final static int PERIOD_PREDICTED = 3;
        public final static int FERTILITY_PREDICTED = 4;
        public final static int OVULATION_PREDICTED = 5;
        public final static int FERTILITY_FUTURE = 6;
        public final static int OVULATION_FUTURE = 7;
        public final static int INFERTILE_PREDICTED = 8;
        public final static int INFERTILE_FUTURE = 9;
        public int type;
        public final GregorianCalendarExt date;
     ...
     */
    public final Vector<DayEntry> dayEntries;
    /**
     ...
     */
    public int cycleLongest;
    /**
     * Calculated shortest cycle length
     */
    public int cycleShortest;
     ...
     */
    @SuppressLint("DefaultLocale")
    public void addPeriod(GregorianCalendar date) {
        String statement;
     ...
     * @param date Date of the entry
     */
    public void removePeriod(GregorianCalendar date) {
        String statement;
    ...
    public int getEntryType(GregorianCalendar date) {
     ...
     * @param date Date of the entry
     */
    public DayEntry getEntry(GregorianCalendar date) {
        for (DayEntry entry : dayEntries) {
            // If entry was found, then return entry
            if (entry.date.equals(date)) {
                return entry;
     ...
     * @param day   Day of the month (1-31)
     */
    public DayEntry getEntryWithDetails(int year, int month, int day) {
     ...
     */
    @SuppressLint("DefaultLocale")
    public void addEntryDetails(DayEntry entry) {
        String statement;
        String dateString = format(Locale.getDefault(), "%04d%02d%02d",
